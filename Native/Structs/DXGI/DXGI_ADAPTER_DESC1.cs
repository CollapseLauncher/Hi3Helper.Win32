...
/// <remarks>The <b>DXGI_ADAPTER_DESC1</b> structure provides a DXGI 1.1 description of an adapter.  This structure is initialized by using the <a href="https://docs.microsoft.com/windows/desktop/api/dxgi/nf-dxgi-idxgiadapter1-getdesc1">IDXGIAdapter1::GetDesc1</a> method.</remarks>
public unsafe struct DXGI_ADAPTER_DESC1
{
    ...
    private DXGI_ADAPTER_FLAG _Flags;

    internal DXGI_ADAPTER_FLAG Flags
    {
        get => _Flags;
        set => _Flags = value;
    }
