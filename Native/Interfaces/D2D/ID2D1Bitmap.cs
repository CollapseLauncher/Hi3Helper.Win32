...
public partial interface ID2D1Bitmap : ID2D1Image
{
    ...
    void CopyFromBitmap(nint /* optional D2D_POINT_2U* */ destPoint, [MarshalUsing(typeof(ComInterfaceMarshaller<ID2D1Bitmap>))] ID2D1Bitmap bitmap, nint /* optional D2D_RECT_U* */ srcRect);

    // https://learn.microsoft.com/windows/win32/api/d2d1/nf-d2d1-id2d1bitmap-copyfromrendertarget
    void CopyFromRenderTarget(nint /* optional D2D_POINT_2U* */ destPoint, [MarshalUsing(typeof(ComInterfaceMarshaller<ID2D1RenderTarget>))] ID2D1RenderTarget renderTarget, nint /* optional D2D_RECT_U* */ srcRect);
