...
public partial interface ID2D1DeviceContext : ID2D1RenderTarget
{
    ...
    void CreateBitmap(D2D_SIZE_U size, nint /* optional void* */ sourceData, uint pitch, in D2D1_BITMAP_PROPERTIES1 bitmapProperties, [MarshalUsing(typeof(UniqueComInterfaceMarshaller<ID2D1Bitmap1>))] out ID2D1Bitmap1 bitmap);
    ...
    void CreateBitmapFromWicBitmap([MarshalUsing(typeof(UniqueComInterfaceMarshaller<IWICBitmapSource>))] IWICBitmapSource wicBitmapSource, nint /* optional D2D1_BITMAP_PROPERTIES1* */ bitmapProperties, [MarshalUsing(typeof(UniqueComInterfaceMarshaller<ID2D1Bitmap1>))] out ID2D1Bitmap1 bitmap);

    // https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-createcolorcontext
    void CreateColorContext(D2D1_COLOR_SPACE space, nint /* optional byte* */ profile, uint profileSize, [MarshalUsing(typeof(UniqueComInterfaceMarshaller<ID2D1ColorContext>))] out ID2D1ColorContext colorContext);

    // https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-createcolorcontextfromfilename
    void CreateColorContextFromFilename(string? filename, [MarshalUsing(typeof(UniqueComInterfaceMarshaller<ID2D1ColorContext>))] out ID2D1ColorContext colorContext);
    ...
    void CreateBitmapFromDxgiSurface(/*[MarshalUsing(typeof(UniqueComInterfaceMarshaller<IDXGISurface>))] IDXGISurface*/ nint surface, in D2D1_BITMAP_PROPERTIES1 bitmapProperties, [MarshalUsing(typeof(UniqueComInterfaceMarshaller<ID2D1Bitmap1>))] out ID2D1Bitmap1 bitmap);
    ...
    void CreateImageBrush([MarshalUsing(typeof(UniqueComInterfaceMarshaller<ID2D1Image?>))] ID2D1Image? image, in D2D1_IMAGE_BRUSH_PROPERTIES imageBrushProperties, nint /* optional D2D1_BRUSH_PROPERTIES* */ brushProperties, [MarshalUsing(typeof(UniqueComInterfaceMarshaller<ID2D1ImageBrush>))] out ID2D1ImageBrush imageBrush);
    ...
    void CreateBitmapBrush([MarshalUsing(typeof(UniqueComInterfaceMarshaller<ID2D1Bitmap?>))] ID2D1Bitmap? bitmap, nint /* optional D2D1_BITMAP_BRUSH_PROPERTIES1* */ bitmapBrushProperties, nint /* optional D2D1_BRUSH_PROPERTIES* */ brushProperties, [MarshalUsing(typeof(UniqueComInterfaceMarshaller<ID2D1BitmapBrush1>))] out ID2D1BitmapBrush1 bitmapBrush);

    // https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-createcommandlist
    void CreateCommandList([MarshalUsing(typeof(UniqueComInterfaceMarshaller<ID2D1CommandList>))] out ID2D1CommandList commandList);
    ...
    void GetImageLocalBounds([MarshalUsing(typeof(UniqueComInterfaceMarshaller<ID2D1Image>))] ID2D1Image image, out D2D_RECT_F localBounds);

    // https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-getimageworldbounds
    void GetImageWorldBounds([MarshalUsing(typeof(UniqueComInterfaceMarshaller<ID2D1Image>))] ID2D1Image image, out D2D_RECT_F worldBounds);
    ...
    [PreserveSig]
    void SetTarget([MarshalUsing(typeof(UniqueComInterfaceMarshaller<ID2D1Image?>))] ID2D1Image? image);
    ...
    [PreserveSig]
    void DrawBitmap([MarshalUsing(typeof(UniqueComInterfaceMarshaller<ID2D1Bitmap>))] ID2D1Bitmap bitmap, in D2D_RECT_F /* optional D2D_RECT_F* */ destinationRectangle, float opacity, D2D1_INTERPOLATION_MODE interpolationMode, in D2D_RECT_F /* optional D2D_RECT_F* */ sourceRectangle, nint /* optional D2D_MATRIX_4X4_F* */ perspectiveTransform);
    ...
    [PreserveSig]
    void PushLayer(in D2D1_LAYER_PARAMETERS1 layerParameters, [MarshalUsing(typeof(UniqueComInterfaceMarshaller<ID2D1Layer?>))] ID2D1Layer? layer);

    // https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-invalidateeffectinputrectangle
    void InvalidateEffectInputRectangle([MarshalUsing(typeof(UniqueComInterfaceMarshaller<ID2D1Effect>))] ID2D1Effect effect, uint input, in D2D_RECT_F inputRectangle);

    // https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-geteffectinvalidrectanglecount
    void GetEffectInvalidRectangleCount([MarshalUsing(typeof(UniqueComInterfaceMarshaller<ID2D1Effect>))] ID2D1Effect effect, out uint rectangleCount);

    // https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-geteffectinvalidrectangles
    void GetEffectInvalidRectangles([MarshalUsing(typeof(UniqueComInterfaceMarshaller<ID2D1Effect>))] ID2D1Effect effect, [In][Out][MarshalUsing(CountElementName = nameof(rectanglesCount))] D2D_RECT_F[] rectangles, uint rectanglesCount);

    // https://learn.microsoft.com/windows/win32/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-geteffectrequiredinputrectangles
    void GetEffectRequiredInputRectangles([MarshalUsing(typeof(UniqueComInterfaceMarshaller<ID2D1Effect>))] ID2D1Effect renderEffect, nint /* optional D2D_RECT_F* */ renderImageRectangle, [In][MarshalUsing(CountElementName = nameof(inputCount))] D2D1_EFFECT_INPUT_DESCRIPTION[] inputDescriptions, [In][Out][MarshalUsing(CountElementName = nameof(inputCount))] D2D_RECT_F[] requiredInputRects, uint inputCount);
