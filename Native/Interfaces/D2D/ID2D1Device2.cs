...
public partial interface ID2D1Device2 : ID2D1Device1
{
    ...
    void CreateDeviceContext(D2D1_DEVICE_CONTEXT_OPTIONS options, [MarshalUsing(typeof(ComInterfaceMarshaller<ID2D1DeviceContext2>))] out ID2D1DeviceContext2 deviceContext2);

    // https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1device2-flushdevicecontexts
    [PreserveSig]
    void FlushDeviceContexts([MarshalUsing(typeof(ComInterfaceMarshaller<ID2D1Bitmap>))] ID2D1Bitmap bitmap);

    // https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1device2-getdxgidevice
    void GetDxgiDevice([MarshalUsing(typeof(ComInterfaceMarshaller<IDXGIDevice>))] out IDXGIDevice dxgiDevice);
}