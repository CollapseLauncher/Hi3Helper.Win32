...
public partial interface ID2D1CommandSink
{
    ...
    void DrawBitmap([MarshalUsing(typeof(ComInterfaceMarshaller<ID2D1Bitmap>))] ID2D1Bitmap bitmap, nint /* optional D2D_RECT_F* */ destinationRectangle, float opacity, D2D1_INTERPOLATION_MODE interpolationMode, nint /* optional D2D_RECT_F* */ sourceRectangle, nint /* optional D2D_MATRIX_4X4_F* */ perspectiveTransform);
    ...
    void PushLayer(in D2D1_LAYER_PARAMETERS1 layerParameters1, [MarshalUsing(typeof(ComInterfaceMarshaller<ID2D1Layer?>))] ID2D1Layer? layer);
