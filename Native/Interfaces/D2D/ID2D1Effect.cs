...
public partial interface ID2D1Effect : ID2D1Properties
{
    ...
    [PreserveSig]
    void SetInput(uint index, [MarshalUsing(typeof(ComInterfaceMarshaller<ID2D1Image?>))] ID2D1Image? input, BOOL invalidate);
    ...
    [PreserveSig]
    void GetInput(uint index, [MarshalUsing(typeof(ComInterfaceMarshaller<ID2D1Image>))] out ID2D1Image input);
    ...
    [PreserveSig]
    void GetOutput([MarshalUsing(typeof(ComInterfaceMarshaller<ID2D1Image>))] out ID2D1Image outputImage);
}