...
public partial interface ID3D11Device3 : ID3D11Device2
{
    ...
    void CreateShaderResourceView1([MarshalUsing(typeof(UniqueComInterfaceMarshaller<ID3D11Resource>))] ID3D11Resource pResource, nint /* optional D3D11_SHADER_RESOURCE_VIEW_DESC1* */ pDesc1, nint /* optional ID3D11ShaderResourceView1* */ ppSRView1);

    // https://learn.microsoft.com/windows/win32/api/d3d11_3/nf-d3d11_3-id3d11device3-createunorderedaccessview1
    void CreateUnorderedAccessView1([MarshalUsing(typeof(UniqueComInterfaceMarshaller<ID3D11Resource>))] ID3D11Resource pResource, nint /* optional D3D11_UNORDERED_ACCESS_VIEW_DESC1* */ pDesc1, nint /* optional ID3D11UnorderedAccessView1* */ ppUAView1);

    // https://learn.microsoft.com/windows/win32/api/d3d11_3/nf-d3d11_3-id3d11device3-createrendertargetview1
    void CreateRenderTargetView1([MarshalUsing(typeof(UniqueComInterfaceMarshaller<ID3D11Resource>))] ID3D11Resource pResource, nint /* optional D3D11_RENDER_TARGET_VIEW_DESC1* */ pDesc1, nint /* optional ID3D11RenderTargetView1* */ ppRTView1);
    ...
    [PreserveSig]
    void GetImmediateContext3([MarshalUsing(typeof(UniqueComInterfaceMarshaller<ID3D11DeviceContext3>))] out ID3D11DeviceContext3 ppImmediateContext);
